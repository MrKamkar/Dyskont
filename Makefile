...
COMMON_SRCS = $(SRC_DIR)/pamiec_wspoldzielona.c $(SRC_DIR)/logi.c $(SRC_DIR)/semafory.c $(SRC_DIR)/kasjer.c
...
all: $(MAIN_TARGET) $(KLIENT_TARGET) $(KASJER_TARGET)
...
# Czyszczenie
clean:
	rm -f $(SRC_DIR)/*.o $(MAIN_TARGET) $(KLIENT_TARGET) $(KASJER_TARGET)
